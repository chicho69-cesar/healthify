...
diabetes_1 = pd.read_csv(
  "C:/workspace/healthify/healthify-data/etl/extract/datasets/diabetes-1.csv"
)
diabetes_2 = pd.read_csv(
    "C:/workspace/healthify/healthify-data/etl/extract/datasets/diabetes-2.csv"
)
diabetes_3 = pd.read_csv(
    "C:/workspace/healthify/healthify-data/etl/extract/datasets/diabetes-3.csv"
)
diabetes_4 = pd.read_csv(
    "C:/workspace/healthify/healthify-data/etl/extract/datasets/diabetes-4.csv"
)

# Observamos los tipos de datos de los datasets
print(diabetes_1.dtypes)
print(diabetes_2.dtypes)
print(diabetes_3.dtypes)
print(diabetes_4.dtypes)
...
# Cambiar el nombre de la columna 'Diagnosis' a 'Outcome' en diabetes_4
...
diabetes_final.to_csv(
    "C:/workspace/healthify/healthify-data/etl/transform/diabetes-pre.csv", index=False
)

# Guardar el dataset final
diabetes_final.to_csv(
    "C:/workspace/healthify/healthify-data/etl/load/diabetes.csv", index=False
)
